<div class="modal fade text-left w-100" id="ubahForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel20"
    aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="barang_id" name="barang_id" type="text" class="form-control" placeholder=""
                                    hidden>
