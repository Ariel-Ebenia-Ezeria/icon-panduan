...
<div class="page-heading">
    ...
    <section class="section">
        ...
        <!-- Modal Tambah Form -->
        @include('pages.dashboard.faq.modal_tambah')
        <!-- End Modal Tambah Form -->

         <!-- Modal Ubah -->
       @include('pages.dashboard.faq.modal_edit')
        <!-- Modal Ubah Form -->
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        ubahFormModal.addEventListener('show.bs.modal', function (event) {
            ...
            // Isi input di modal
            ubahFormModal.querySelector('#pertanyaan').value = pertanyaan;
            ubahFormModal.querySelector('#jawaban').value = jawaban;
    
            // Set action form (jika pakai route update)
            ubahFormModal.querySelector('form').action = `/faq/${id}`;
        });
    });
</script>
            ...
            button.addEventListener('click', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        deleteForm.action = `/faq/${itemId}`; // Sesuaikan URL jika pakai prefix
                        deleteForm.submit();
                    }
                });
            });
